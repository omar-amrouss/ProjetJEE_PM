...
const TaskCard = ({ task }) => {
  ...
  return (
    <>
      <div className='w-full h-fit bg-gray-800 shadow-md p-4 rounded'>
        <div className='w-full flex justify-between'>
          ...
          >
            ...
            <span className='uppercase'>{task?.priority == "HIGH" ? "Haute": task?.priority == "MEDIUM" ? "Mediume":"Bas"} Priorité</span>
          </div>
            {/* here to modify the open task with admin and user */}
        ...
        {task?.subTasks?.length > 0 ? (
          <div className='py-4 border-t border-gray-200'>
            ...
            <div className='pt-3 space-x-8'>
              <span className='text-sm text-gray-200'>
                {formatDate(new Date(task?.subTasks[0]?.date))}
              </span>
              <span className='bg-gray-200 px-3 py-1 rounded text-blue-900 font-medium'>
                {task?.subTasks[0].tag}
              </span>
            </div>
          </div>
          ...
          <>
            {/* <div className='py-4 border-t border-gray-200'>
              <span className='text-gray-200'>no projet name</span>
            </div>
