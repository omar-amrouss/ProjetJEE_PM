...
const Users = () => {
  ...
  const userActionHandler = async () => {
    try {
      ...
      refetch()
      toast.success("l'utilisateur à été créer")
      setSelected(null)
      setTimeout(() => {
        setOpenAction(false)
      },500)
  ...
  const deleteHandler = async () => {
    try {
      ...
      refetch()
      toast.success("l'utilisateur à été suprimé")
      setSelected(null)
      setTimeout(() => {
        setOpenDialog(false)
      },500)
  ...
  const TableHeader = () => (
    <thead className='border-b border-gray-300'>
      <tr className='text-white text-left'>
        <th className='py-2'>Nom Et Prenom</th>
  ...
  const TableRow = ({ user }) => (
    <tr className='border-b border-gray-200 text-gray-200 hover:bg-gray-400/10'>
      ...
      <td className='p-2 flex gap-4 justify-end'>
        <Button
          className='text-blue-400 hover:text-blue-500 font-semibold sm:px-0'
          label='Modifier'
          type='button'
        ...
        <Button
          className='text-red-400 hover:text-red-500 font-semibold sm:px-0'
          label='Supprimer'
          type='button'
