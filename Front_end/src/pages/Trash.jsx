...
const Trash = () => {
  ...
  const deleteAllClick = () => {
    setType("deleteAll");
    setMsg("Vous voulez suprrimer tous les taches?");
    setOpenDialog(true);
  };

  const restoreAllClick = () => {
    setType("restoreAll");
    setMsg("Vous voulez restorer tous les taches?");
    setOpenDialog(true);
  };

  const deleteClick = (id) => {
    setType("delete");
    setMsg("Vous voulez supprimer cette tache?");
    setSelected(id);
    setOpenDialog(true);
  };
  ...
  const restoreClick = (id) => {
    setSelected(id);
    setType("restore");
    setMsg("Vous voulez restorer cette tache?");
    setOpenDialog(true);
  };
  ...
  const TableRow = ({ item }) => (
    <tr className='border-b border-gray-200 text-gray-200 hover:bg-gray-400/10'>
      ...
      <td className='py-2 flex gap-1 justify-end'>
        <Button
          icon={<MdOutlineRestore className='text-xl text-gray-200' />}
  ...
  return (
    <>
      <div className='w-full md:px-1 px-0 mb-6'>
        <div className='flex items-center justify-between mb-8'>
          ...
          <div className='flex gap-2 md:gap-4 items-center'>
            <Button
              ...
              className='flex flex-row-reverse gap-1 items-center  text-gray-200 text-sm md:text-base rounded-md 2xl:py-2.5'
        ...
        <div className='bg-gray-800 px-2 md:px-6 py-4 shadow-md rounded'>
